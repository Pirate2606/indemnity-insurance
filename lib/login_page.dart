...
import 'package:idemnity/otp.dart';
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Container(
              padding:
                  EdgeInsets.only(top: 5.47.h, left: 11.39.w, right: 11.39.w),
              child: Center(
                child: Text(
                  "By Continuing you accept our Terms&Conditions and our Privacy Policy",
                  style: TextStyle(
                    fontSize: 14.0,
                    color: Color(0XFF333258),
                  ),
            ...
            Container(
              padding:
                  EdgeInsets.only(top: 15.6.h, left: 27.68.w, right: 27.68.w),
              child: TextButton(
                style: ButtonStyle(
